...
set RUTA_PROGRAMA="\\woody\asan\Servicios\EnfermeriaMedPreventiva\APLICACIONES\AUTOMATIZACION\informeFIRMA"
...
echo Generando Informe para FIRMA Microbiologica con fecha %date%
