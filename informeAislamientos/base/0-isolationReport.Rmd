...
tabla_cruzada %>%
  ...
  print()
cat("BLEE: betalactamasa de expectro extendido.EPC: enterobacterias productoras de carbapenemasa.\nMMR: microorganismo multirresistente resistente a 3 o más grupos antimicrobianos\nR meticilina: Staphylococcus aureus resistente a meticilina (SARM) u otros microorganismos resistentes a meticilina.\nOtros: Stenotrophomonas maltophilia, Serratia marcescens, microorganismos productores de ampC.")
```
